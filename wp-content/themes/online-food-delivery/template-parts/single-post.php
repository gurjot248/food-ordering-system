...
<article>
	...
	<?php if( get_theme_mod( 'online_food_delivery_single_post_date',true) != '' || get_theme_mod( 'online_food_delivery_single_post_comment_no',true) != '' || get_theme_mod( 'online_food_delivery_single_post_author',true) != '' || get_theme_mod( 'online_food_delivery_single_post_time',true) != '') { ?>
      ...
      <?php if( get_theme_mod( 'online_food_delivery_single_post_comment_no',true) != '') { ?>
        <span class="entry-comments me-2 px-2"><i class="fas fa-comments me-1"></i> <?php comments_number( __('0 Comments','online-food-delivery'), __('0 Comments','online-food-delivery'), __('% Comments','online-food-delivery') ); ?></span>
      <?php } ?>

      <?php if( get_theme_mod( 'online_food_delivery_single_post_time',false) != '') { ?>
